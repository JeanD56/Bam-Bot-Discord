...
class CommandUtil {
    ...
    constructor(handler, message) {
        ...
        this.messages = this.handler instanceof CommandHandler_js_1.default && this.handler.storeMessages ? new discord_js_1.Collection() : null;
    ...
    addMessage(message) {
        if (this.handler instanceof CommandHandler_js_1.default && this.handler.storeMessages) {
